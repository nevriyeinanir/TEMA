...
/>  
 ...
 data:function(){
  return {
    cards: {
      sales: { name : "Sales", type: "a"},
      revenue: { name : "Revenue", type: "a"},
      clients: { name : "Clients", type: "a"},
      users: { name : "Users", type: "a"},
    }
...
import Card2_ from '../components/Card2_.vue'
// @ is an alias to /src
...
export default {
  ...
  return {
    ...
    cards: {
      sales: { name : "Sales", type: "a"},
      revenue: { name : "Revenue", type: "c"},
      clients: { name : "Clients", type: "b"},
      users: { name : "Users", type: "a"},
    }
