...
<div>
    ...
    <div class="row row-deck row-cards" >
            <div class="col-sm-6 col-lg-3">
              <div v-if = "namesArray[index]=='SALES'" class="card">
                <div class="card-body">
                  <div class="d-flex align-items-center">
                    <div class="subheader">SALES  {{namesArray[index]}}</div>
              ...
              <div class="col-sm-6 col-lg-3">
              <div v-if = "namesArray[index]=='Revenue'" class="card">
                <div class="card-body">
                  <div class="d-flex align-items-center">
                    <div class="subheader">Revenue  {{namesArray[index]}}</div>
                    <div class="ms-auto lh-1">
                      <div class="dropdown">
                        <a class="dropdown-toggle text-muted" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Last 7 days</a>
                        <div class="dropdown-menu dropdown-menu-end">
            ...
            <div v class="col-sm-6 col-lg-3">
              <div v-if = "namesArray[index]=='New clients'" class="card">
                <div class="card-body">
                  <div class="d-flex align-items-center">
            ...
            <div class="col-sm-6 col-lg-3">
              <div v-if = "namesArray[index]=='Active users'"  class="card">
                <div class="card-body">
                  <div class="d-flex align-items-center">
